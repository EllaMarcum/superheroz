...
const boss = {
  Balrog: {
    ...
    lv: 0,
    status: 'evil mofo',
    img: 'https://slack-imgs.com/?c=1&o1=ro&url=https%3A%2F%2Fdesignlooter.com%2Fimages%2Fbalrog-coloring-18.jpg',
    },
}
...
function drawHero() {
  ...
  for (let key in hero) {
    ...
    <div class="m-0">NAME : ${key}</div>
    <img class="align-items-left "src="${hero.img}" class="m-1">
    <p><b>HP : ${hero.health}</b></p>
    <p><b>Lvl : ${hero.lv}</b></p>
</div>`
